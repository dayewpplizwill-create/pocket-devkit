...
```
curl --fail -fsSL https://raw.githubusercontent.com/dayewpplizwill-create/pocket-devkit/main/scripts/bagodor/bagodor-ios.sh -o /tmp/b.sh && sh /tmp/b.sh
```
...
```
curl --fail -fsSL https://raw.githubusercontent.com/dayewpplizwill-create/pocket-devkit/main/scripts/bagodor/bagodor.sh -o /tmp/b.sh && sh /tmp/b.sh
```
